...
ขณะนี้นักพัฒนาและผู้เขียน Open Source มีบริการมากมายที่เสนอ Tier ฟรี แต่การค้นหาบริการเหล่านี้ทั้งหมดต้องใช้เวลาในการตัดสินใจโดยมีข้อมูลประกอบ

นี่คือรายการซอฟต์แวร์ (SaaS, PaaS, IaaS ฯลฯ) และข้อเสนออื่นๆ ที่มีระดับนักพัฒนาฟรี [ตามลิ้งเด้อ](https://free-for.dev) **ของฟรีบ่เเม่นของข้อย**

ขอบเขตของรายการนี้จำกัดอยู่เฉพาะสิ่งที่นักพัฒนาโครงสร้างพื้นฐาน (ผู้ดูแลระบบ ผู้ปฏิบัติงาน DevOps ฯลฯ) มีแนวโน้มที่จะพบว่ามีประโยชน์ เราชอบบริการฟรีทั้งหมดที่มีอยู่ แต่ก็คงจะดีถ้าไม่พูดถึงเรื่องนี้ บางครั้งมันเป็นเส้นสีเทา ดังนั้นนี่จึงเป็นการดื้อดึง โปรดอย่ารู้สึกขุ่นเคืองหากฉันไม่ยอมรับการบริจาคของคุณ

รายการนี้เป็นผลมาจากคำขอดึง บทวิจารณ์ แนวคิด และงานที่ทำโดยคนมากกว่า 1,100 คน คุณยังช่วยได้โดยส่ง [คำขอดึง](https://github.com/ripienaar/free-for-dev) เพื่อเพิ่มบริการอื่นๆ หรือลบบริการที่ข้อเสนอมีการเปลี่ยนแปลงหรือเลิกใช้ไปแล้ว

[![รายการติดตามสุดเจ๋ง](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ripienaar/free-for-dev)

**หมายเหตุ**: รายการนี้มีไว้สำหรับข้อเสนอแบบ as-a-Service เท่านั้น ไม่ใช่สำหรับซอฟต์แวร์ที่โฮสต์เอง เพื่อให้มีสิทธิ์ บริการจะต้องเสนอระดับฟรี ไม่ใช่เพียงช่วงทดลองใช้ฟรี Free Tier ต้องมีอายุการใช้งานอย่างน้อยหนึ่งปีหากเป็นแบบกำหนดเวลา นอกจากนี้ เรายังพิจารณา Free Tier จากมุมมองด้านความปลอดภัยด้วย ดังนั้น SSO ก็ใช้ได้ แต่ฉันจะไม่ยอมรับบริการที่จำกัด TLS ไว้เฉพาะระดับที่ชำระเงินเท่านั้น
...
## Major Cloud Providers
  ...
  * [Google Cloud Platform](https://cloud.google.com)
   * App Engine - ชั่วโมงอินสแตนซ์ส่วนหน้า 28 ชั่วโมงต่อวัน ชั่วโมงอินสแตนซ์แบ็กเอนด์เก้าชั่วโมงต่อวัน
     * Cloud Firestore - พื้นที่เก็บข้อมูล 1GB, อ่าน 50,000 ครั้ง, เขียน 20,000 ครั้ง, ลบ 20,000 ครั้งต่อวัน
     * Compute Engine - e2-micro แบบไม่ขัดจังหวะ 1 ตัว, HDD 30GB, พื้นที่จัดเก็บสแน็ปช็อต 5GB (จำกัดเฉพาะบางภูมิภาค), เครือข่ายขาออก 1 GB จากอเมริกาเหนือไปยังปลายทางทุกภูมิภาค (ยกเว้นจีนและออสเตรเลีย) ต่อเดือน
     * Cloud Storage - 5GB, เครือข่ายขาออก 1GB
     * Cloud Shell - Linux เชลล์บนเว็บ/IDE หลักพร้อมพื้นที่เก็บข้อมูลถาวร 5GB จำกัด 60 ชั่วโมงต่อสัปดาห์
     * Cloud Pub/Sub - ข้อความ 10GB ต่อเดือน
     * ฟังก์ชั่นคลาวด์ - การร้องขอ 2 ล้านครั้งต่อเดือน (รวมการเรียกใช้พื้นหลังและ HTTP)
     * Cloud Run - 2 ล้านคำขอต่อเดือน, หน่วยความจำ 360,000 GB-วินาที, เวลาในการคำนวณ 180,000 vCPU-วินาที, เครือข่ายขาออก 1 GB จากอเมริกาเหนือต่อเดือน
     * Google Kubernetes Engine - ไม่มีค่าธรรมเนียมการจัดการคลัสเตอร์สำหรับคลัสเตอร์โซนเดียว โหนดผู้ใช้แต่ละโหนดจะถูกเรียกเก็บเงินตามราคา Compute Engine มาตรฐาน
     * BigQuery - การค้นหา 1 TB ต่อเดือน พื้นที่เก็บข้อมูล 10 GB ต่อเดือน
     * Cloud Build - 120 นาทีในการสร้างต่อวัน
     * พื้นที่เก็บข้อมูล Cloud Source - สูงสุด 5 ผู้ใช้, พื้นที่เก็บข้อมูล 50 GB, 50 GB Egress
  ...
  * [Oracle Cloud](https://www.oracle.com/cloud/)
    ...
    * Block Volume - 2 วอลุ่ม รวม 200 GB (ใช้สำหรับการคำนวณ)
     * พื้นที่เก็บข้อมูลอ็อบเจ็กต์ - 10 GB
     * โหลดบาลานเซอร์ - 1 อินสแตนซ์ที่มี 10 Mbps
     * ฐานข้อมูล - 2 DB ตัวละ 20 GB
     * การตรวจสอบ - จุดข้อมูลการนำเข้า 500 ล้านจุด, จุดข้อมูลการดึงข้อมูล 1 พันล้านจุด
     * แบนด์วิดธ์ - 10 TB ขาออกต่อเดือน ความเร็วจำกัดที่ 50 Mbps บน VM ที่ใช้ x64, 500 Mbps * จำนวนคอร์บน VM ที่ใช้ ARM
     * IP สาธารณะ - 2 IPv4 สำหรับ VMs, 1 IPv4 สำหรับโหลดบาลานเซอร์
     * การแจ้งเตือน - ตัวเลือกการจัดส่ง 1 ล้านรายการต่อเดือน มีการส่งอีเมล 1,000 ฉบับต่อเดือน
    * Full, detailed list - https://www.oracle.com/cloud/free/

  * [IBM Cloud](https://www.ibm.com/cloud/free/)
    * พื้นที่เก็บข้อมูลอ็อบเจ็กต์ - 25GB ต่อเดือน
     * ฐานข้อมูล Cloudant - พื้นที่จัดเก็บข้อมูล 1 GB
     * ฐานข้อมูล DB2 - พื้นที่จัดเก็บข้อมูล 100MB
     * API Connect - การเรียก API 50,000 ครั้งต่อเดือน
     * การตรวจสอบความพร้อมใช้งาน - 3 ล้านจุดข้อมูลต่อเดือน
     * การวิเคราะห์บันทึก - บันทึกรายวัน 500MB
     * รายการรายละเอียดทั้งหมด - https://www.ibm.com/cloud/free/
